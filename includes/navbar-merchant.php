...
<!-- Sidebar - Brand -->
<a class="sidebar-brand d-flex " href="merchant-index.php">
...
<!-- Nav Item - Dashboard -->
<li class="nav-item">
  <a class="nav-link" href="merchant-index.php">
...
<!-- Nav Item - Products -->
<li class="nav-item">
  <a class="nav-link" href="merchant-products.php">
    <i class="fas fa-fw fa-table"></i>
    <span>Products</span></a>
</li>
<!-- Nav Item - Orders -->
<li class="nav-item">
  <a class="nav-link" href="merchantorder.php">
      ...
      <div id="content">
        ...
        <?php else : ?>
          ...
          <ul class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item"  href="merchant-profile.php">
